...
if (NOT ILASTIK_DEPENDENCY_DIR)
    message (FATAL_ERROR "ERROR: ilastik build directory (for all downloads & builds) should be specified via -DILASTIK_DEPENDENCY_DIR=<path> on cmake command line.")
endif ()
...
macro (external_source ABBREV SRC_VERSION FILENAME MD5)
    ...
    set (${ABBREV}_FILE         ${ILASTIK_DEPENDENCY_DIR}/src/${FILENAME})
    set (${ABBREV}_MD5          ${MD5})
    set (${ABBREV}_RELEASE      ${SRC_VERSION})
    set (${ABBREV}_SRC_DIR      ${ILASTIK_DEPENDENCY_DIR}/src/${external_source_name})
    set (${ABBREV}_INCLUDE_DIRS ${ILASTIK_DEPENDENCY_DIR}/include)
